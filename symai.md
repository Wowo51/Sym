...
If you start playing with the library itself, note that the model produced forecasts normalized solutions between 0 and 1. These can be converted to proper forecasts with the ScaleAndOffsetForecast function in the Forecasting class. The scale and offset you'll need are in the ProcessDefinition class you can create. If you go through the SymRegressionApp code a bit you can get a top down view of using the library.
