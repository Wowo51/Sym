...
namespace Sym
{
    public class Solver
    {
        ...
        public Node Solve(List<Node> system, List<Transform> inTransforms, int maxRepetitions, int populationSize, List<Goal> goals, List<Operator> operators)
        {
            ...
            SortedSet<string> existingEquationStrings = new SortedSet<string>();
            existingEquationStrings.UnionWith(potentialAnswers.Select(x => x.EquationString).ToList());
        ...
        public static void ProcessUntransformedAnswer(PotentialAnswer potentialAnswer, SortedSet<string> existingEquationStrings, ref bool foundNonExistantAnswer, List<PotentialAnswer> potentialAnswers, List<Operator> operators, List<Goal> goals, List<Transform> inTransforms, ref bool stopSolving, bool useSubstitutions)
        {
        ...
        public static void ProcessNewAnswer(Node newAnswer, SortedSet<string> existingEquationStrings, ref bool foundNonExistantAnswer, List<PotentialAnswer> potentialAnswers, List<Operator> operators, List<Goal> goals)
        {
        ...
        public static void Substitute(Node newAnswer, List<PotentialAnswer> existingAnswers, SortedSet<string> existingEquationStrings, ref bool foundNonExistantAnswer, List<Operator> operators, List<Goal> goals, ref bool stopSolving)
        {
